...
var itemHeadlines = document.querySelectorAll(
".timeline-item > .timeline-headline");

var overlay = document.querySelector(".timeline-overlay");
var backButton = document.querySelector(".timeline-back");var _iteratorNormalCompletion = true;var _didIteratorError = false;var _iteratorError = undefined;try {var _loop = function _loop() {
...
function handleItemClick(id) {
  ...
  if (!isExpanded) {
    ...
    var itemChildContents = document.querySelectorAll("[data-timeline=" +
    id + "] .timeline-content > *");

    var itemPhotoImg = itemPhoto.querySelector("img");
    var unSelectedItems = document.querySelectorAll("[data-timeline]:not([data-timeline=" +
    id + "])");

    var unSelectedChildItems = document.querySelectorAll("[data-timeline]:not([data-timeline=" +
    id + "]) > *:not(.timeline-photo)");
    ...
    TweenMax.to(itemPhoto, 1, { boxShadow: "0 10px 30px rgba(0,0,0, .2)" });var _iteratorNormalCompletion2 = true;var _didIteratorError2 = false;var _iteratorError2 = undefined;try {

      for (var _iterator2 = items[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {_i = _step2.value;
